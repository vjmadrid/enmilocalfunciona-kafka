...
public class GenericSerializerDeserializerTest {

	byte[] customMessageByteArrayTest = null;
	
	private GenericSerializer<CustomMessage> genericSerializer;
	...
	public void init() throws IOException {
		genericSerializer = new GenericSerializer<CustomMessage>();
