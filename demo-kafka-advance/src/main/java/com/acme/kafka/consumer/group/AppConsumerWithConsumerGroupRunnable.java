...
public class AppConsumerWithConsumerGroupRunnable {
    ...
    public static void main(String[] args) throws InterruptedException {
    	...
    	// xxx
        ConsumerGroupRunnable consumerGroup =  new ConsumerGroupRunnable(GlobalKafkaConstant.DEFAULT_BOOTSTRAP_SERVERS, DemoConstant.GROUP_ID, DemoConstant.TOPIC, NUM_CONSUMERS);
