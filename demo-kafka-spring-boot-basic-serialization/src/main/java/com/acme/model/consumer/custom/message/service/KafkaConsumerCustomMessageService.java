package com.acme.model.consumer.custom.message.service;
...
@Service
public class KafkaConsumerCustomMessageService {

	private static final Logger LOG = LoggerFactory.getLogger(KafkaConsumerCustomMessageService.class);
