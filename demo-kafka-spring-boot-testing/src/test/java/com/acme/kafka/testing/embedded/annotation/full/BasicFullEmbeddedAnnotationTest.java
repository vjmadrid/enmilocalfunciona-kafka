...
public class BasicFullEmbeddedAnnotationTest {
	
	public static final Logger LOG = LoggerFactory.getLogger(BasicFullEmbeddedAnnotationTest.class);
	...
	@Test
	public void givenEmbeddedKafkaWithTopicInjected_whenSendMenssageWithService_thenMessageIsReceived() throws InterruptedException {
		messageTest = String.format(TestingConstant.MESSAGE_TEMPLATE, "id_1", new Date().toString(), "topic :"+topic);
