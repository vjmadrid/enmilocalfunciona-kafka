...
public class AppConsumerWithConsumerGroupRunnable {
    ...
    public static void main(String[] args) throws InterruptedException {
    	...
    	LOG.info("[AppConsumerWithConsumerGroupRunnable] *** Init ***");

    	//Se puede disparar aqui el consumidor
    	
    	// xxx
        ConsumerGroupRunnable consumerGroup =  new ConsumerGroupRunnable("localhost:9092","group-1",DemoConstant.TOPIC, NUM_CONSUMERS);
