...
public class BasicProducerWithCallback {
	...
	private static final Logger LOG = LoggerFactory.getLogger(BasicProducerWithCallback.class);
    ...
    public static void main(String[] args) throws InterruptedException, ExecutionException {
        ...
        for (int i=1; i<=NUM_MESSAGES; i++ ) {
            ...
            LOG.info("[BasicProducerWithCallback] sending message='"+message+"' to topic='"+TOPIC+"'");
        ...
        LOG.info("[BasicProducerWithCallback] *** End ***");
    }
