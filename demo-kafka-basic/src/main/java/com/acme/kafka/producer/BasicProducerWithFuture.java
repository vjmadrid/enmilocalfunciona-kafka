...
public class BasicProducerWithFuture {
	
	private static final Logger LOG = LoggerFactory.getLogger(BasicProducerWithFuture.class);
	
    public static void main(String[] args) throws InterruptedException, ExecutionException {
    	
    	LOG.info("[BasicProducerWithFuture] *** Init ***");
        ...
        LOG.info("[BasicProducerWithFuture] Preparing to send {} menssages", DemoConstant.NUM_MESSAGES);
        for (int i=1; i<=DemoConstant.NUM_MESSAGES; i++ ) {
            ...
            LOG.info("[BasicProducerWithFuture] sending message='{}' to topic='{}'", message, DemoConstant.TOPIC);
        ...
        LOG.info("[BasicProducerWithFuture] *** End ***");
    }
